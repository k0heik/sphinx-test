...
from spai.service.cvr.preprocess import CVRPreprocessor, agg_feature_cols, agg_query_feature_cols, get_dtypes
...
def test_service(df, df_query):
    ...
    service = CVRPredictionService(preprocessor, estimator)
