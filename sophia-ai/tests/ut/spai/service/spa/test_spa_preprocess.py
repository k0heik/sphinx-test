...
from spai.service.spa.preprocess import SPAPreprocessor, agg_feature_cols, agg_query_feature_cols
from spai.service.spa.config import FEATURE_COLUMNS
...
def test_preprocess(df, df_query, is_use_dask):
    ...
    # weightがconversionsになっているかの確認
    np.testing.assert_array_equal(
        result_df["weight"].values,
        df["conversions"].values
    )
